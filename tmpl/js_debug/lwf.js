// Copyright (c) 2012 GREE, Inc - The zlib License http://git.io/uvS3hQ
// Copyright (c) 2010-2012 Tween.js authors - The MIT License http://git.io/tiDrNw
  ...
  WebkitCSSResourceCache = (function() {
        ...
        if (workerJS != null) {
          (function(workerJS) {
            ...
            if (useWorkerWithArrayBuffer) {
              return worker.webkitPostMessage(data);
            } else {
    ...
    WebkitCSSResourceCache.prototype.loadLWFData = function(settings, url) {
      ...
      xhr.onreadystatechange = function() {
        ...
        data = useArrayBuffer ? xhr.response : xhr.responseText;
