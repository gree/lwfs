...
b.useBackgroundColor=!0;b.fitForHeight=!1;b.fitForWidth=!1;"fitForWidth"===this.resizeMode?b.fitForWidth=!0:"fitForHeight"===this.resizeMode?b.fitForHeight=!0:"fitToScreen"===this.resizeMode&&(this.fitToScreen=!0);b.fitToScreen=this.fitToScreen;b.worker=x;w&&/ (SC-0|Galaxy Nexus|SH-0|SCL21)/.test(n)&&(b.quirkyClearRect=!0);w&&(b.use3D=!1);b.privateData={};b.pos=null;b.imageMap={};b.soundMap={};b.pageTransitionMap={};b.buttonEventMap={};b.fsCommandMap={};b.handler={};b.callback={};b.lwfMap=null;for(var e=
function(a){return a.charAt(1).toUpperCase()},d=0;d<a.attributes.length;d++){var k=a.attributes[d];if(k.name&&0===k.name.indexOf("data-lwf-")){var m=k.name.slice(9),m=m.replace(/_./g,e);if("displaySetting"!==m){k=k.value;try{"{"===k.charAt(0)&&(k=JSON.parse(k))}catch(u){}b[m]=k}}}2===g.devicePixelRatio&&this.useLargeImage&&(b.imageSuffix="_@2x");b.hasOwnProperty("lwf")||(e=a.getAttribute("data-lwf"),_.isString(e)&&(b.lwf=e));b.hasOwnProperty("name")&&(b.lwf=b.name);_.isObject(h)&&_.extend(b,h);0<
this.initializeHooks.length&&_.each(this.initializeHooks,_.bind(function(c){if(_.isFunction(c)){c=c.call(this,a);for(var d in c)c.hasOwnProperty(d)&&_.extend(b[d],c[d])}},this));this.initializeHooks=[];if(!b.hasOwnProperty("lwf"))throw Error("[LWF] no LWF input");e={};e.debugInfoElementId=++z;e.setting=b;e.loader=this;e.debug=!1;e.soundMap=null;e.pageTransitionMap=null;e.buttonEventMap=null;e.fsCommandMap=null;e.handler=null;e.callback=null;e.stageEventReceiver=null;e.lwfMap=null;e.debug=this.debug;
b.privateData.hasOwnProperty("lwfLoader")||(b.privateData.lwfLoader=this);b.imageMap=this.getImageMapper_(b.imageMap);_.isEmpty(b.soundMap)||(e.soundMap=b.soundMap);delete b.soundMap;_.isObject(b.pageTransitionMap)&&(e.pageTransitionMap=b.pageTransitionMap);delete b.pageTransitionMap;e.buttonEventMap=b.buttonEventMap;delete b.buttonEventMap;_.isEmpty(b.fsCommandMap)||(e.fsCommandMap=b.fsCommandMap);delete b.fsCommandMap;_.isEmpty(b.handler)||(e.handler=b.handler);delete b.handler;e.callback=b.callback;
delete b.callback;e.lwfMap=b.lwfMap;delete b.lwfMap;e.fitToScreen=b.fitToScreen;delete b.fitToScreen;this.isLwfsEnvironment_()&&(d=b.prefix?b.prefix+b.lwf:b.lwf,b.prefix=d.slice(0,d.lastIndexOf("/")+1),delete b.imagePrefix,b.lwf=d.slice(d.lastIndexOf("/")+1));d={position:"absolute",top:0,left:0};_.extend(d,b.pos);delete b.pos;if("static"===a.style.position||""===a.style.position)a.style.position="relative";c=J(c);c.style.position=d.position;c.style.top=d.top+"px";c.style.left=d.left+"px";c.style.zIndex=
a.style.zIndex+1;a.appendChild(c);m=null;t?(m=document.createElement("div"),m.style.position="absolute",m.style.top=d.top+"px",m.style.left=d.left+"px",m.style.zIndex=c.style.zIndex+1,a.appendChild(m)):m=c;b.stage=c;e.stageEventReceiver=m;if(this.debug||e.debug)c=document.createElement("div"),c.id="lwf_info"+z,c.style.position=d.position,c.style.top=d.top+"px",c.style.left=d.left+"px",c.style.color="white",c.style.zIndex=1E4,a.appendChild(c);if(b.lwf){e.useLwfJs=/\.lwf.js(\?.*)?$/.test(b.lwf);if(b.hasOwnProperty("_loaderData"))throw Error("cannot use '_loaderData' property that used by lwf-loader!");
b.privateData._loaderData=e;f.loadLWF(b)}else console.error("[LWF] no LWF input")};k.prototype.requestLWF_=function(a,h,f,c,b){var e={},d={},e={};if(this.isLwfsEnvironment_()){d=_.clone(window.testlwf_settings);d.prefix?e=d.prefix+h+"/_/":(e=document.location.pathname,e=e.replace(a.name,h),e=e.slice(0,e.lastIndexOf("/")+1)+"_/");d.prefix=e;delete d.imagePrefix;e=this.getLwfPath_(h);if(!e)return console.error("[LWF] no LWF input"),b("no LWF input",null),null;d.lwf=e;d.parentLWF=a;d.stage=a.stage;d.worker=
x;d.active=!1;f&&(d.imageMap=this.getImageMapper_(f));c&&(d.privateData=c);d.onload=function(a){var c={},c=_.isUndefined(this.privateData)||_.isUndefined(this.privateData.lwfLoader)?new k:this.privateData.lwfLoader;return a?b(null,a):(c.handleLoadError_(this),b(this.error,a))}}else{d=a.privateData;if("undefined"===typeof d)return console.error("[LWF] Parent private data is not found"),b("no parents data found",null),null;var g=_.clone(d._loaderData);if("undefined"===typeof g)return console.error("[LWF] Parent Loader data is not found"),
b("no loader parameters to inherit"),null;d=_.clone(g.setting);this.useAbsImagePath?d.imagePrefix="":this.useDefaultImgPath&&(d.imagePrefix=h+"/");d.fitForHeight=d.fitForWidth=!1;g.setting=d;if(this.isLwfsLoaderEnvironment_())e=document.location.pathname,e=e.replace(a.name,h),e=e.slice(0,e.lastIndexOf("/")+1)+"_/",d.prefix=e,delete d.imagePrefix,e=this.getLwfPath_(h);else{e=null;try{e=this.getLwfMapper_(g)(h)}catch(m){this.handleException_(m,g)}}if(!e)return console.error("[LWF] no LWF input"),b("no LWF input",
null),null;d.lwf=e;g.useLwfJs&&(d.lwf+=".js");d.parentLWF=a;d.stage=a.stage;d.worker=x;d.active=!1;f&&(d.imageMap=this.getImageMapper_(f));c&&(c._loaderData=g,d.privateData=c,c.prefix&&(d.prefix=c.prefix),c.imagePrefix&&(d.imagePrefix=c.imagePrefix));d.onload=function(a){var c=g.loader;return a?b(null,a):(c.handleLoadError_(this,g),b(this.error,a))}}return d};k.prototype.requestLWF=function(a,g,f,c,b){a=this.requestLWF_(a,g,f,c,b);_.isNull(a)||this.requests.push(a)};k.prototype.loadLWF=function(a,
h,f,c,b){a=this.requestLWF_(a,h,f,c,b);_.isNull(a)||g.LWF.ResourceCache.get().loadLWF(a)};k.prototype.loadLWFs=function(a){g.LWF.ResourceCache.get().loadLWFs(this.requests,a);this.requests=[]};g.LwfLoader=k})(window);
