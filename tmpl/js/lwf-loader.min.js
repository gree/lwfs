...
delete b.callback;e.lwfMap=b.lwfMap;delete b.lwfMap;e.fitToScreen=b.fitToScreen;delete b.fitToScreen;this.isLwfsEnvironment_()?(d=b.prefix?b.prefix+b.lwf:b.lwf,b.prefix=d.slice(0,d.lastIndexOf("/")+1),delete b.imagePrefix,b.lwf=d.slice(d.lastIndexOf("/")+1)):b.lwf=this.getLwfMapper_(e)(b.lwf);d={position:"absolute",top:0,left:0};_.extend(d,b.pos);delete b.pos;if("static"===a.style.position||""===a.style.position)a.style.position="relative";c=J(c);c.style.position=d.position;c.style.top=d.top+"px";
c.style.left=d.left+"px";c.style.zIndex=a.style.zIndex+1;a.appendChild(c);m=null;t?(m=document.createElement("div"),m.style.position="absolute",m.style.top=d.top+"px",m.style.left=d.left+"px",m.style.zIndex=c.style.zIndex+1,a.appendChild(m)):m=c;b.stage=c;e.stageEventReceiver=m;if(this.debug||e.debug)c=document.createElement("div"),c.id="lwf_info"+z,c.style.position=d.position,c.style.top=d.top+"px",c.style.left=d.left+"px",c.style.color="white",c.style.zIndex=1E4,a.appendChild(c);if(b.lwf){e.useLwfJs=
/\.lwf.js(\?.*)?$/.test(b.lwf);if(b.hasOwnProperty("_loaderData"))throw Error("cannot use '_loaderData' property that used by lwf-loader!");b.privateData._loaderData=e;f.loadLWF(b)}else console.error("[LWF] no LWF input")};k.prototype.requestLWF_=function(a,h,f,c,b){var e={},d={},e={};if(this.isLwfsEnvironment_()){d=_.clone(window.testlwf_settings);d.prefix?e=d.prefix+h+"/_/":(e=document.location.pathname,e=e.replace(a.name,h),e=e.slice(0,e.lastIndexOf("/")+1)+"_/");d.prefix=e;delete d.imagePrefix;
e=this.getLwfPath_(h);if(!e)return console.error("[LWF] no LWF input"),b("no LWF input",null),null;d.lwf=e;d.parentLWF=a;d.stage=a.stage;d.worker=x;d.active=!1;f&&(d.imageMap=this.getImageMapper_(f));c&&(d.privateData=c);d.onload=function(a){var c={},c=_.isUndefined(this.privateData)||_.isUndefined(this.privateData.lwfLoader)?new k:this.privateData.lwfLoader;return a?b(null,a):(c.handleLoadError_(this),b(this.error,a))}}else{d=a.privateData;if("undefined"===typeof d)return console.error("[LWF] Parent private data is not found"),
b("no parents data found",null),null;var g=_.clone(d._loaderData);if("undefined"===typeof g)return console.error("[LWF] Parent Loader data is not found"),b("no loader parameters to inherit"),null;d=_.clone(g.setting);this.useAbsImagePath?d.imagePrefix="":this.useDefaultImgPath&&(d.imagePrefix=h+"/");d.fitForHeight=d.fitForWidth=!1;g.setting=d;if(this.isLwfsLoaderEnvironment_())e=document.location.pathname,e=e.replace(a.name,h),e=e.slice(0,e.lastIndexOf("/")+1)+"_/",d.prefix=e,delete d.imagePrefix,
e=this.getLwfPath_(h);else{e=null;try{e=this.getLwfMapper_(g)(h)}catch(m){this.handleException_(m,g)}}if(!e)return console.error("[LWF] no LWF input"),b("no LWF input",null),null;d.lwf=e;g.useLwfJs&&(d.lwf+=".js");d.parentLWF=a;d.stage=a.stage;d.worker=x;d.active=!1;f&&(d.imageMap=this.getImageMapper_(f));c&&(c._loaderData=g,d.privateData=c,c.prefix&&(d.prefix=c.prefix),c.imagePrefix&&(d.imagePrefix=c.imagePrefix));d.onload=function(a){var c=g.loader;return a?b(null,a):(c.handleLoadError_(this,g),
